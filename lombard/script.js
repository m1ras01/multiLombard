...
const translations = {
    ru: {
        ...
        // Banner
        'banner.title': 'Мульти ломбард в Каратау',
        'banner.subtitle': 'Быстрые займы под залог золота, техники и других ценностей. Надежный партнер в Жамбылской области.',
        ...
        'about.text1': 'Мульти ломбард работает в городе Каратау уже более 10 лет. За это время мы зарекомендовали себя как надежный и честный партнер для жителей Жамбылской области.',
        'about.text2': 'Мы специализируемся на оценке и приеме в залог драгоценных металлов, ювелирных изделий, часов, электроники и других ценных предметов. Наш офис удобно расположен в центре города Каратау.',
        ...
        'contacts.address.street': 'г. Каратау, ул. Молдагулова 33',
        'contacts.address.btn': 'Показать карту',
        'contacts.hours.title': 'Режим работы',
        'contacts.hours.weekdays': 'Пн-Пт: 9:00 - 20:00',
        'contacts.hours.weekends': 'Сб-Вс: 10:00 - 18:00',
        'contacts.map.title': 'Как нас найти',
        'contacts.map.desc': 'Мы находимся в центре города Каратау, на улице Молдагулова 33. Удобная парковка и доступность общественным транспортом.',
        
        // Footer
        'footer.logo.title': 'Мульти ломбард',
        'footer.logo.subtitle': 'Надежный партнер',
        'footer.description': 'Мульти ломбард в Каратау. Быстрые займы под залог с выгодными условиями.',
        'footer.services.title': 'Услуги',
        'footer.services.item1': 'Микрокредиты',
        'footer.services.item2': 'Залог золота',
        'footer.services.item3': 'Оценка техники',
        'footer.info.title': 'Информация',
        'footer.info.item1': 'О компании',
        'footer.info.item2': 'Контакты',
        'footer.info.item3': 'Условия',
        'footer.contacts.title': 'Контакты',
        'footer.contacts.address': 'г. Каратау, ул. Молдагулова 33',
    ...
    kz: {
        ...
        // Banner
        'banner.title': 'Қаратаудағы Мульти ломбард',
        'banner.subtitle': 'Алтын, техника және басқа құндылықтарға қаржылық несие. Жамбыл облысындағы сенімді серіктес.',
        ...
        'about.text1': 'Мульти ломбард Қаратау қаласында 10 жылдан астам жұмыс істейді. Осы уақыт ішінде біз Жамбыл облысы тұрғындары үшін сенімді және адал серіктес ретінде өз кілтімізді таныттық.',
        'about.text2': 'Біз қымбатты металдар, зергерлік бұйымдар, сағаттар, электроника және басқа құндылықтарды бағалау және қаржылық несиеге алу бойынша маманданамыз. Біздің кеңсе Қаратау қаласының орталығында ыңғайлы орналасқан.',
        ...
        'contacts.address.street': 'Қаратау қ., Молдагулова көш. 33',
        'contacts.address.btn': 'Картаны көрсету',
        'contacts.hours.title': 'Жұмыс уақыты',
        'contacts.hours.weekdays': 'Дс-Жм: 9:00 - 20:00',
        'contacts.hours.weekends': 'Сб-Жс: 10:00 - 18:00',
        'contacts.map.title': 'Бізді қалай табуға болады',
        'contacts.map.desc': 'Біз Қаратау қаласының орталығында, Молдагулова көшесі 33-те орналасқанбыз. Ыңғайлы автотұрақ және қоғамдық көлікпен қол жетімділік.',
        
        // Footer
        'footer.logo.title': 'Мульти ломбард',
        'footer.logo.subtitle': 'Сенімді серіктес',
        'footer.description': 'Қаратаудағы Мульти ломбард. Тиімді шарттармен қаржылық несие.',
        'footer.services.title': 'Қызметтер',
        'footer.services.item1': 'Микрокредиттер',
        'footer.services.item2': 'Алтынға қаржылық несие',
        'footer.services.item3': 'Техниканы бағалау',
        'footer.info.title': 'Ақпарат',
        'footer.info.item1': 'Компания туралы',
        'footer.info.item2': 'Байланыс',
        'footer.info.item3': 'Шарттар',
        'footer.contacts.title': 'Байланыс',
        'footer.contacts.address': 'Қаратау қ., Молдагулова көш. 33',
